    ...
    <section id="products" className="py-24 md:py-32 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <Link
            href="/products"
            className="inline-flex items-center gap-2 mt-5 text-sm tracking-wider uppercase text-accent hover:text-accent/80 transition-colors animate-fade-in-up group"
          >
